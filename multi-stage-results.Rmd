...
We can then create a bump chart style polot showing how each driver's positioned changed across stages:
...
formattable(overall_wide_pos_top5) %>% kableExtra::kable_styling( stripe_color="white") %>% as.htmlwidget()
