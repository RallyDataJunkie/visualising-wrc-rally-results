...
$$\textrm{GAP}{j}=t_{j,\textrm{GAP}}=t_{j,1,DIFF}=t_j-t_1$$
...
$$\textrm{GAP}{j}=t_{j,\textrm{GAP}}=0+\sum_{m=1}^{j}\textrm{DIFF}_{m,m-1}=\sum_{m=1}^{j}\left ( t_m-t_{m-1} \right ): j\ge1, t_0=t_1$$
